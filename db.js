...
const getRandomBook = () =>
  getBookById(getRandomIntInclusive(1, data.books.length));
...
const getRandomAuthor = () =>
  getAuthorById(getRandomIntInclusive(1, data.authors.length));
...
const getRandomUser = () =>
  getUserById(getRandomIntInclusive(1, data.users.length));
